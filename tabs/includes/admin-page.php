...
<div class="wrap">
    <h1><?php esc_html_e('Manage Page Tabs', 'suitewp'); ?></h1>

    <div class="pto-admin-container">
        <!-- Tabs section -->
        <div class="pto-tabs-section">
            <h2><?php esc_html_e('Tabs', 'suitewp'); ?></h2>

            <div class="pto-add-tab-form">
                <h3><?php esc_html_e('Create New Tab', 'suitewp'); ?></h3>
                <form id="pto-tab-form">
                    <input type="hidden" id="tab-id" name="tab_id" value="0">

                    <table class="form-table">
                        <tr>
                            <th scope="row">
                                <label for="tab-name"><?php esc_html_e('Name', 'suitewp'); ?> *</label>
                            </th>
                            <td>
                        ...
                        <tr>
                            <th scope="row">
                                <label for="tab-description"><?php esc_html_e('Description', 'suitewp'); ?></label>
                            </th>
                            <td>
                        ...
                        <tr>
                            <th scope="row">
                                <label for="tab-color"><?php esc_html_e('Color', 'suitewp'); ?></label>
                            </th>
                            <td>
                        ...
                        <tr>
                            <th scope="row">
                                <label for="tab-position"><?php esc_html_e('Position', 'suitewp'); ?></label>
                            </th>
                            <td>
            ...
            <!-- Existing tabs list -->
            <div class="pto-tabs-list">
                <h3><?php esc_html_e('Existing Tabs', 'suitewp'); ?></h3>

                <?php if (empty($tabs)) : ?>
                    <p><?php esc_html_e('No tabs created yet.', 'suitewp'); ?></p>
                <?php else : ?>
                    <table class="wp-list-table widefat fixed striped">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('Name', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Description', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Color', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Pages', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Position', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Actions', 'suitewp'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="pto-pages-section">
            <h2><?php esc_html_e('Assign Pages to Tabs', 'suitewp'); ?></h2>

            <?php if (empty($tabs)) : ?>
                <p><?php esc_html_e('You must create at least one tab before you can assign pages.', 'suitewp'); ?></p>
            <?php elseif (empty($pages)) : ?>
                <p><?php esc_html_e('No pages available to assign.', 'suitewp'); ?></p>
            <?php else : ?>
                <div class="pto-pages-assignment">
                    <table class="wp-list-table widefat fixed striped">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('Page', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Status', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Assigned Tab', 'suitewp'); ?></th>
                                <th><?php esc_html_e('Actions', 'suitewp'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr data-page-id="<?php echo esc_attr($page->ID); ?>">
                                    ...
                                    <td>
                                        ...
                                        <select class="page-tab-select" data-page-id="<?php echo esc_attr($page->ID); ?>">
                                            <option value="0"><?php esc_html_e('No tab', 'suitewp'); ?></option>
                                            <?php foreach ($tabs as $tab) : ?>
...
<div id="pto-messages" class="notice" style="display: none;">
    <p></p>
</div>
